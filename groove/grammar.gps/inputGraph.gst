...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="inputGraph">
        ...
        <node id="n0">
            <attr name="layout">
                <string>143 8 141 64</string>
            </attr>
        </node>
        <node id="n1">
            <attr name="layout">
                <string>50 128 88 96</string>
            </attr>
        </node>
        <node id="n8">
            <attr name="layout">
                <string>59 280 70 48</string>
            </attr>
        </node>
        <node id="n9">
            <attr name="layout">
                <string>218 128 159 64</string>
            </attr>
        </node>
        <node id="n10">
            <attr name="layout">
                <string>253 248 90 64</string>
            </attr>
        </node>
        <edge from="n0" to="n0">
            <attr name="label">
