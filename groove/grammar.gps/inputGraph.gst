...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="inputGraph">
        ...
        <node id="n0">
            <attr name="layout">
                <string>116 8 120 80</string>
            </attr>
        </node>
        <node id="n1">
            <attr name="layout">
                <string>88 275 88 112</string>
            </attr>
        </node>
        <node id="n8">
            <attr name="layout">
                <string>81 565 70 64</string>
            </attr>
        </node>
        <node id="n9">
            <attr name="layout">
                <string>407 176 83 32</string>
            </attr>
        </node>
        <node id="n10">
            <attr name="layout">
                <string>516 356 82 80</string>
            </attr>
        </node>
        <edge from="n0" to="n0">
            <attr name="label">
