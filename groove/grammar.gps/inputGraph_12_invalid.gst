...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="inputGraph_12_invalid">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n2">
            <attr name="layout">
                <string>499 162 108 48</string>
            </attr>
        </node>
        <node id="n3">
            <attr name="layout">
                <string>690 158 106 64</string>
            </attr>
        </node>
        <node id="n4">
            <attr name="layout">
                <string>503 27 108 48</string>
            </attr>
        </node>
        <node id="n5">
            <attr name="layout">
                <string>697 17 74 64</string>
            </attr>
        </node>
        <edge from="n0" to="n0">
            <attr name="label">
