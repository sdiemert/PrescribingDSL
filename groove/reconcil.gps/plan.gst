...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="plan">
        ...
        <node id="n31">
            <attr name="layout">
                <string>248 232 141 48</string>
            </attr>
        </node>
        <node id="n32">
            <attr name="layout">
                <string>347 336 80 48</string>
            </attr>
        </node>
        <node id="n34">
            <attr name="layout">
                <string>352 440 70 32</string>
            </attr>
        </node>
        <node id="n35">
            <attr name="layout">
                <string>507 336 82 48</string>
            </attr>
        </node>
        <node id="n36">
            <attr name="layout">
                <string>396 128 141 48</string>
            </attr>
        </node>
        <node id="n37">
            <attr name="layout">
                <string>643 232 80 48</string>
            </attr>
        </node>
        <node id="n39">
            <attr name="layout">
                <string>648 336 70 32</string>
            </attr>
        </node>
        <node id="n40">
            <attr name="layout">
                <string>803 232 82 48</string>
            </attr>
        </node>
        <edge from="n1" to="n1">
            <attr name="label">
